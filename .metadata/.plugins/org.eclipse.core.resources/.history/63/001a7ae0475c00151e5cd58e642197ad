package BufferSincronizadoAlmacenadoVarios;
...
public class Main {
	...
	final static int valoresMax = 3000;
	final static int cantidadProductores = 100;
	final static int cantidadConsumidores = 100;
	...
	public static void main(String[] args) {
		...
		Buffer buffer = new Buffer(escribir, leer, valoresMax);
